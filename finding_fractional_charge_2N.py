...
np.savetxt('eig_val_2N_clean_dope30_L'+str(Lx)+'W'+str(Ly)+'_U'+str(U)+'_gamma'+str(gamma)+'.txt', val)
np.savetxt('eig_vec_2N_clean_dope30_L'+str(Lx)+'W'+str(Ly)+'_U'+str(U)+'_gamma'+str(gamma)+'.txt', vec)